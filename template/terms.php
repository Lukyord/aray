        ...
        <div class="sc-inner sc-inner--follows sc-inner--bottom-extra">
            <div class="container">
                <div class="sc-ttl animate fadeIn">
                    <h1 class="size-h1 uppercase">Privacy & Terms</h1>
                </div>

                <div class="tab-links animate fadeIn">
                    <div class="swiper auto centered-m click">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="tab clickable">
                                    <a href="<?php echo $root; ?>terms.php" class="active">Terms & Conditions</a>
                                </div>
                            </div>
                ...
                <div class="content">
                    ...
                    <div class="entry-content entry-fadeIn">
                        ...
                        <h3>Cookies</h3>
                        <p>We employ the use of cookies. By accessing Website Name, you agreed to use cookies in agreement with the Company Name's </p>
                        ...
                        <figure class="wp-block-image size-large is-resized">
                            <img src="./assets/media/design/map.jpg" alt="" style="width: 490px; height: auto;">
                        </figure>
